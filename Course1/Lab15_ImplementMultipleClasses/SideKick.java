...
/** TODO 7 Solution : Implement the interface "KungFuSkills"
 *                    created in TODO 5. is given by using
 *                    "implements KungFuSkills" in the line
 *                    below and then implementing the method
 *                    of the interface.
 **/
public class SideKick extends Robot implements KungFuSkills {
   ...
   // method to set choice
    ...
    /** TODO 5 Solution: Implementing the method **/
    @Override
    public void kungFuProtection() {
        /** TODO 6 Solution : Give the functionality inside the the methods
