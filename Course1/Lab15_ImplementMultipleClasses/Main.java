...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (menuChoice) {
                case 1:
                    /** TODO 1 Solution: Use the "sideKickObject", object of Sidekick class
                    ...
                    /** TODO 7 Solution: Check if the "SideKick" class has implemented the
                ...
                case 2:
                    /** TODO 2 Solution: Use the "driverBot" object of WatADriver class
                     *                  to display the menu and then take the appropriate
                     *                  action as required.
                     **/
                    driverBot.setChoice();
    ...
    /** TODO 4: In the interface "KungFuSkills" created in TODO5,
